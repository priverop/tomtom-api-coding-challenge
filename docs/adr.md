...
- BusinessFinder is the method requested in the [Step 1 issue](https://github.com/tomtomapi/ruby-code-challenge-pablo-rivero/issues/1). It acts as the Controller of the application.
